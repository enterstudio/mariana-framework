...
class email{
    ...
    private $smtpServer = 'smtp.gmail.com';             //  The SMTP server you would be connecting to and using to send messages
    private $port = '587';                              //  The port that you would be using to connect to the SMTP server
    private $timeout = 30;                              //  Length of time (in seconds) that the script would try to connect before deciding it won't connect
    private $username = 'pihh.rocks@gmail.com';         //  Gmail Login
    private $password = '92834C8fe6dd125ed5c64d2b6c';   //  Gmail Password
    private $username_email = 'pihh.rocks@gmail.com';   //  Email that recieves the emails ( example you can send by no-reply@mariana-framework.com as recieve in info@mariana-framework.com
    private $newline = "\r\n";                          //  Prrety self explanatory
    private $localdomain = 'http://pihh.rocks.com';     //  Your website
    private $charset = 'windows-1251';                  //  Encoding
