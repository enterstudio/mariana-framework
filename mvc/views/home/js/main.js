...
var scope = {
    paragraph: [
        "The simplest, yet, powerfull frameworkz to build awesome web applications in record time.",
        "Mariana is a PHP MVC frameworkz built having one thing in mind: \"to be the frameworkz with the smallest learning curve ever\". In fact, in order to effectivelly use Mariana Framework you just need to spend 10minutes reading the <a href=\"#\">documentation</a> or watching the <a href=\"#\">video</a> and that's basically it.",
        "Mariana has another cool feature: You can download full systems and just copy and paste them. Every codeyou download from the repository has a video explaining it. This way, you don't have to loose hugeamounts of time trying to understand what's in the code. Feel free to try it on this  <a href=\"https://github.com/pihh/mariana-frameworkz/archive/master.zip\" download>link</a>."
    ],
